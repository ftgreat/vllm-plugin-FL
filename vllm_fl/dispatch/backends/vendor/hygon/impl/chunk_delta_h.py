...
# Hygon DCU (gfx926) optimized chunk_gated_delta_rule_fwd_kernel_h_blockdim64.
#
# Key change: Replace libtuner with autotuned configs including BV=64 + num_stages=1.
# exp_34 showed BV=32 + num_stages=1 had no effect. BV=64 + num_stages=1 is a blind
